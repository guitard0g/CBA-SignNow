...
if __name__ == '__main__':
    ...
    documents_folder = signnow.Folder.get(access_token['access_token'], documents_folder_id, 50, 0,
    ...
    offset = 0
    documents_folder = signnow.Folder.get(access_token['access_token'], documents_folder_id, 20, offset)
    print 'Folder name:', documents_folder['name']
