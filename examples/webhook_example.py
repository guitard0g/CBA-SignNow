...
if __name__ == "__main__":
    ...
    webhook_response = signnow.Webhook.create(
        access_token["access_token"], "document.update", "http://requestb.in/sdfcflsd"
    )
    ...
    for subscription in webhooks["subscriptions"]:
        ...
        deleted_response = signnow.Webhook.delete(
            access_token["access_token"], subscription["id"]
        )
