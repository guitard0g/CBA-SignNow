...
if __name__ == '__main__':
    ...
    webhook_response = signnow.Webhook.create(access_token['access_token'], 'document.update',
    ...
    webhooks = signnow.Webhook.list_all(access_token['access_token'])
    ...
    for subscription in webhooks['subscriptions']:
        ...
        deleted_response = signnow.Webhook.delete(access_token['access_token'], subscription['id'])
